/**importing neccacery packages*/
import java.awt.event.*;
import java.awt.*;
import javax.swing.*;

/**Creating class which extends JFram*/
class WardenControlPanel extends JFrame implements ActionListener
{
	...
	public  WardenControlPanel()
	{
		...
		footer=new JPanel();
		center=new JPanel();
		labelcp=new JLabel("<html><u>Warden Control Panel</u></html>");
	...
	/**All things will be addedd using this method*/
	public void adding()
	{
		...
		center.add(Line5);
		center.add(addw);
		addw.setEnabled(false);
		center.add(updatew);
		updatew.setEnabled(false);
		center.add(addp);
		center.add(updatep);
		center.add(releasep);
		center.add(Line6);
