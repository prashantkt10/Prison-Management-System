...
import javax.swing.*;
import java.sql.*;
class DeleteWarden extends JFrame implements ActionListener
{
	private JButton btdelete, btclear, btcancel, btsearch;
	...
	public DeleteWarden()
	{
		...
		footer=new JPanel();
		center=new JPanel();
		lblh=new JLabel("____Delete Warden____");
	...
	public void ItemsAdd()
	{
		...
		btdelete.setBounds(120,415, 80,40);
...
btdelete.addActionListener(this);
	...
	{
		DeleteWarden aw=new DeleteWarden();
		aw.ItemsAdd();
...
try
	    {
           ...
           String sql = "delete from WARDENDB where UD="+ id +"";;
           st.execute(sql);
